...
public class TelaPaciente extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String telefone = jTextField5.getText();//pega os dados de todos os textFields e salva em variaveis para facilitar a manipulação
        
        if(Control.inserirPaciente(nome, CPF, RG, endereco, telefone) == true){// se retorno da função de salvar um paciente for true (paciente foi salvo)
        ...
        else{// se retorno da função de salvar um paciente for false (paciente não foi salvo)
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        jTable1.setModel(DbUtils.resultSetToTableModel(Control.buscarPaciente()));//chamar a função de buscar todos os pacientes (e mostrar os dados na jTable)
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       long CPF = Long.parseLong(jTextField6.getText());//Pegar o CPF do textfield
       jTable1.setModel(DbUtils.resultSetToTableModel(Control.buscarUmPaciente(CPF)));//chamar a função de buscar um paciente (e mostrar os dados na jTable)
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       TelaInicial tela = new TelaInicial();//botão voltar
       tela.setVisible(true);
       this.dispose();//fechar esse form e abrir um novo de TelaInicial
